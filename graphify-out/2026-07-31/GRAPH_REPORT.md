# Graph Report - predictotronix  (2026-07-30)

## Corpus Check
- 94 files · ~38,247 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 465 nodes · 809 edges · 37 communities (30 shown, 7 thin omitted)
...
1. `createServiceClient()` - 48 edges
2. `isSuperAdmin()` - 43 edges
3. `getUser` - 40 edges
4. `createClient()` - 28 edges
5. `requireUser()` - 21 edges
6. `compilerOptions` - 17 edges
7. `getParticipant()` - 16 edges
8. `ApiFixture` - 12 edges
9. `scripts` - 11 edges
10. `Graphify Skill` - 11 edges
...
Cohesion: 0.09
Nodes (37): submitJoinRequest(), dynamic, JoinPage(), Props, dynamic, dynamic, DashboardPage(), dynamic (+29 more)

### Community 1 - "createServiceClient"
Cohesion: 0.12
Nodes (38): dynamic, ExportsAdminPage(), correctResult(), FixturesAdminPage(), createLeague(), regenerateInviteCode(), toggleInviteActive(), dynamic (+30 more)
...
Cohesion: 0.05
Nodes (43): @base-ui/react, class-variance-authority, clsx, lucide-react, next, dependencies, @base-ui/react, class-variance-authority (+35 more)
...
Cohesion: 0.33
Nodes (5): Deployment outline, Isolation model, Planned deterministic scenario, Safety controls, Staging environment

### Community 11 - "environment.ts"
Cohesion: 0.14
Nodes (18): dynamic, POST(), validateCronSecret(), APP_ENVIRONMENTS, AppEnvironment, assertSafeStagingTarget(), EnvironmentPolicy, EnvironmentSource (+10 more)
