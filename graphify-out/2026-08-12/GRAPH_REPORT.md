...
## Corpus Check
- 124 files · ~48,613 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 623 nodes · 1094 edges · 43 communities (34 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6753d4c3`
...
1. `createServiceClient()` - 55 edges
...
Cohesion: 0.07
Nodes (62): cookieOptions, setAdminLeague(), setAdminSeason(), ExportsAdminPage(), correctResult(), dynamic, FixturesAdminPage(), metadata (+54 more)
...
Cohesion: 0.24
Nodes (8): dynamic, metadata, Props, AdminPredictionsForm(), Fixture, Option, ParticipantOption, Props
...
- **Why does `createServiceClient()` connect `createServiceClient` to `createClient`, `environment.ts`, `fixtures/actions.ts`, `exports/page.tsx`, `predictions/page.tsx`?**
