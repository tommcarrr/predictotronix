...
## Corpus Check
- 244 files · ~102,406 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1251 nodes · 2474 edges · 97 communities (77 shown, 20 thin omitted)
...
Cohesion: 0.08
Nodes (35): dynamic, metadata, contentType(), GET(), validFormats, ExportPanel(), Format, formats (+27 more)
...
Cohesion: 0.08
Nodes (45): AdminLayout(), Ball, Brick, CeefaxBreakout(), createBricks(), createGame(), displayName(), drawFootball() (+37 more)
...
Cohesion: 0.09
Nodes (27): setAdminSeason(), AdminShell(), configureNav, NavItem, Option, Props, runNav, SeasonOption (+19 more)
...
Cohesion: 0.06
Nodes (55): main(), requiredEnvironment(), actionLogger(), assertExternalFixtureSyncEnabled(), failureEntry(), getProductionSeason(), SyncActionState, triggerFixtureSync() (+47 more)
...
Cohesion: 0.08
Nodes (35): dynamic, metadata, buildCronDiagnosticPrompt(), CronJobRunStatus, CronJobStatusPanel(), formatDuration(), formatUtc(), statusStyles (+27 more)
...
Cohesion: 0.09
Nodes (26): GameweekWorkbookPrediction, calculateCompletion(), getResult(), LeaderboardEntry, RankedEntry, rankLeaderboard(), Result, Score (+18 more)

### Community 60 - "[leagueId]/page.tsx"
Cohesion: 0.13
Nodes (25): dynamic, LeagueTab, dynamic, metadata, Props, dynamic, metadata, Props (+17 more)

### Community 61 - "server.ts"
Cohesion: 0.14
Nodes (23): correctResult(), approveJoinRequest(), createOfflineParticipant(), rejectJoinRequest(), updateParticipantDisplayName(), dynamic, metadata, Props (+15 more)
...
### Community 63 - "auth/index.ts"
Cohesion: 0.27
Nodes (15): assignLeagueAdmin(), createLeague(), deleteLeague(), regenerateInviteCode(), toggleInviteActive(), canManageScope(), createLoginNotice(), expireLoginNotice() (+7 more)

### Community 64 - "createServiceClient"
Cohesion: 0.23
Nodes (15): setAdminLeague(), ExportsAdminPage(), FixturesAdminPage(), LeagueDetailPage(), LeaguesAdminPage(), LoginNoticesAdminPage(), AdminDashboardPage(), dynamic (+7 more)
...
Cohesion: 0.23
Nodes (12): DEFAULT_LOGIN_NOTICE_DURATION_MS, formatLondonDateTimeLocal(), getLoginNoticeFormBounds(), LOGIN_NOTICE_DISPLAY_MODES, LOGIN_NOTICE_TONES, LoginNoticeDismissal, londonFormatter, londonParts() (+4 more)
...
Cohesion: 0.13
Nodes (44): dynamic, filenamePart(), GET(), requireLeagueAdminForGameweek(), addCompleteness(), addFixtureAnalysis(), addForecastTendencies(), addLeaderboard() (+36 more)
...
### Community 94 - "Q: The easter-egg prompt belongs on the player dashboard, and the cookie must suppress only prompts rather than game entry."
Cohesion: 0.40
...
## Knowledge Gaps
- **482 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `config` (+477 more)
...
- **Why does `createServiceClient()` connect `createServiceClient` to `leaderboard.ts`, `context.ts`, `send-reminders/route.ts`, `createClient`, `predictions/actions.ts`, `predictions/page.tsx`, `test-tools/page.tsx`, `fixtures.ts`, `fixtures/page.tsx`, `gameweek-workbook.ts`, `[leagueId]/page.tsx`, `server.ts`, `auth/index.ts`?**
