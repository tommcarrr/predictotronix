...
## Corpus Check
- 217 files · ~90,215 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1096 nodes · 2096 edges · 88 communities (69 shown, 19 thin omitted)
...
Cohesion: 0.09
Nodes (31): claimReminderDelivery(), DeliveryClaim, dynamic, POST(), ServiceClient, validateCronSecret(), shouldDryRunNotifications(), BrandedEmailParams (+23 more)
...
### Community 27 - "createServiceClient"
Cohesion: 0.19
Nodes (24): correctResult(), approveJoinRequest(), createOfflineParticipant(), rejectJoinRequest(), updateParticipantDisplayName(), dynamic, metadata, Props (+16 more)
...
### Community 57 - "[seasonId]/page.tsx"
Cohesion: 0.15
Nodes (19): dynamic, LeaguesAdminPage(), metadata, Props, metadata, NewSeasonPage(), dynamic, SeasonTab (+11 more)
...
### Community 59 - "fixtures/page.tsx"
Cohesion: 0.09
Nodes (36): dynamic, metadata, buildCronDiagnosticPrompt(), CronJobRunStatus, CronJobStatusPanel(), formatDuration(), formatUtc(), statusStyles (+28 more)

### Community 60 - "server.ts"
Cohesion: 0.17
Nodes (13): FixturesAdminPage(), LeagueDetailPage(), AdminDashboardPage(), dynamic, metadata, ParticipantsAdminPage(), dynamic, metadata (+5 more)
...
### Community 63 - "fpl/client.ts"
Cohesion: 0.17
Nodes (10): FplBootstrap, FplEvent, fplFetch(), FplFixture, FplFixtureProvider, fplSeason(), fplStatus(), FplTeam (+2 more)

### Community 64 - "predictions/actions.ts"
Cohesion: 0.05
Nodes (67): AdminPredictionsPage(), dynamic, metadata, Props, AdminLayout(), ActiveSeason, DashboardPage(), dynamic (+59 more)
...
### Community 68 - "[leagueId]/page.tsx"
Cohesion: 0.32
...
### Community 69 - "api-football/client.ts"
Cohesion: 0.22
...
### Community 72 - "fixtures/actions.ts"
Cohesion: 0.35
Nodes (9): actionLogger(), assertExternalFixtureSyncEnabled(), failureEntry(), getProductionSeason(), SyncActionState, triggerFixtureSync(), triggerResultSync(), initialSyncActionState (+1 more)
...
### Community 75 - "getEnvironmentPolicy"
Cohesion: 0.36
...
- `ParticipantsAdminPage()` (6× useful, score=4.581800228)
- `DashboardPage()` (3× useful, score=2.2835292)
- `submitJoinRequest()` (3× useful, score=2.267683534)
- `getBreakoutLeaderboard()` (2× useful, score=1.998151315) _(code changed — re-verify)_
- `submitBreakoutScore()` (2× useful, score=1.998151315) _(code changed — re-verify)_
- `CeefaxBreakout()` (2× useful, score=1.997189243)
- `PredictionsForm()` (2× useful, score=1.653613525)
- `SeasonsAdminPage()` (2× useful, score=1.549169222)
- `AdminShell()` (2× useful, score=1.549169222)
- `approveJoinRequest()` (2× useful, score=1.543383059)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `createServiceClient()` connect `createServiceClient` to `leaderboard.ts`, `predictions/actions.ts`, `send-reminders/route.ts`, `[leagueId]/page.tsx`, `auth/actions.ts`, `fixtures/actions.ts`, `AdminShell.tsx`, `test-tools/page.tsx`, `[seasonId]/page.tsx`, `fixtures/page.tsx`, `server.ts`, `context.ts`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `createClient()` connect `predictions/actions.ts` to `createServiceClient`, `auth/actions.ts`, `server.ts`, `[leagueId]/page.tsx`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `getSeasonNow()` connect `predictions/actions.ts` to `test-tools/page.tsx`, `send-reminders/route.ts`, `fixtures/page.tsx`, `server.ts`?**
